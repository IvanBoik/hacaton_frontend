...
const HomeOn = () =>{
    return(
        <>
            <Header title1="Главная" title2="Финансирование" title3="Кредиты" title4="Факторинг" title5="Другое" url="/profile"/>
            <div className={styles.root}>
                ...
                <div className={styles.AllCartsContainer}>
                    <div className={styles.FirstCartsContainer}>
                        ...
                        <Cart name="Факторинг" imgURL={img6}  a={'/chat'} text={'Открыть чат'}/>
                    </div>
                    <div className={styles.SecondCartsContainer}>
                        <Cart name="Кредит на исполнение контракта" imgURL={img7}  a={'/chat'} text={'Открыть чат'}/>
                        <Cart name="Финансирование селлеров маркетплейсов" imgURL={img8}  a={'/chat'} text={'Открыть чат'}/>
                    </div>
                </div>
            </div>
        </>
